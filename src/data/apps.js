export const apps = [
  ...
  },
  {
    ...
    ctas: [
      ...
      {
        label: 'View in App Store',
        href: 'https://apps.apple.com/us/app/until-friday/id6798798566',
        external: true,
      },
    ],
    detail: {
            ...
            },
            {
              ...
              footer: {
                ...
                list: [
                  ...
                  'Monitor family sharing and CloudKit sync behavior in real-world use',
                  'Refine widgets, notifications, and trends based on customer feedback',
                ],
              },
            },
          ],
  ...
  },
  {
    ...
    ctas: [
      ...
      {
        label: 'View in App Store',
        href: 'https://apps.apple.com/us/app/friendly-competitions/id6775539829',
        external: true,
      },
    ],
    detail: {
          ...
          items: [
            ...
            },
            {
              ...
              footer: {
                ...
                list: [
                  'Live on the App Store for iPhone and iPad',
                  'Monitor the host and judge handoff flows in real-world events',
                  'Polish exports and recaps based on customer feedback',
                ],
              },
            },
          ],
